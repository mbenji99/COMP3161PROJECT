...
CREATE TABLE Enrolled(
    ...
    CONSTRAINT CHK_EnrolledCourses CHECK ((SELECT COUNT(*) FROM Enrolled WHERE u_id = Enrolled.u_id) <= 6),
    CONSTRAINT CHK_EnrolledCoursesMin CHECK ((SELECT COUNT(*) FROM Enrolled WHERE u_id = Enrolled.u_id) >= 3));
...
CREATE TABLE Course_Maintainers(
    ...
    CONSTRAINT CHK_TaughtCourses CHECK ((SELECT COUNT(*) FROM Course_Maintainers WHERE lect_id = Course_Maintainers.lect_id) <= 5),
    CONSTRAINT CHK_TaughtCoursesMin CHECK ((SELECT COUNT(*) FROM Course_Maintainers WHERE lect_id = Course_Maintainers.lect_id) >= 1));
